  ...
  return (
    ...
    <div className={"grid  grid-cols-1 grid-rows-12 grid-flow-row "}>
      ...
      <div className="w-full p-4 bg-gray-800 rounded-xl text-white/75">
        ...
        <pre><code className={'text-primary ml-4'}>{'width="100%"'}</code></pre>
        <pre><code className={'text-primary ml-4'}>{'height="288px"'}</code></pre>
        <pre className={"ml-4 text-primary"}><code>{"src="+'"'+`${getEmbeddingCode(backgroundColor,cardColour,textColour,embeddingStyle)}`+'"' +">"}</code></pre>
        <pre><code className={'text-primary'}>{"</iframe>"}</code></pre>
      </div>
