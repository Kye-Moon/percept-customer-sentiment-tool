...
import TutorialImage01 from '../../../../../../simple/simple-react/src/images/tutorial-01.jpg';
import TutorialImage02 from '../../../../../../simple/simple-react/src/images/tutorial-02.jpg';
import TutorialImage03 from '../../../../../../simple/simple-react/src/images/tutorial-03.jpg';
import TutorialImage04 from '../../../../../../simple/simple-react/src/images/tutorial-04.jpg';
import TutorialImage05 from '../../../../../../simple/simple-react/src/images/tutorial-05.jpg';
import TutorialImage06 from '../../../../../../simple/simple-react/src/images/tutorial-06.jpg';
import TutorialImage07 from '../../../../../../simple/simple-react/src/images/tutorial-07.jpg';
import TutorialImage08 from '../../../../../../simple/simple-react/src/images/tutorial-08.jpg';
import TutorialImage09 from '../../../../../../simple/simple-react/src/images/tutorial-09.jpg';
import NewsAuthor01 from '../../../../../../simple/simple-react/src/images/news-author-01.jpg';
import NewsAuthor02 from '../../../../../../simple/simple-react/src/images/news-author-02.jpg';
import NewsAuthor03 from '../../../../../../simple/simple-react/src/images/news-author-03.jpg';
import NewsAuthor04 from '../../../../../../simple/simple-react/src/images/news-author-04.jpg';
import NewsAuthor05 from '../../../../../../simple/simple-react/src/images/news-author-05.jpg';
import NewsAuthor06 from '../../../../../../simple/simple-react/src/images/news-author-06.jpg';
          ...
          <div className="border-b border-gray-300 pb-4 mb-12">
            <ul className="flex flex-wrap justify-center md:justify-start font-medium -mx-5 -my-1">
              <li className="mx-5 my-1">
                <a className="text-blue-600" href="./TutorialsList#0">All</a>
              </li>
              <li className="mx-5 my-1">
                <a className="text-gray-800 hover:underline" href="./TutorialsList#0">Tutorials</a>
              </li>
              <li className="mx-5 my-1">
                <a className="text-gray-800 hover:underline" href="./TutorialsList#0">Tips & Tricks</a>
              </li>
              <li className="mx-5 my-1">
                <a className="text-gray-800 hover:underline" href="./TutorialsList#0">Free ebooks</a>
              </li>
              <li className="mx-5 my-1">
                <a className="text-gray-800 hover:underline" href="./TutorialsList#0">Guides</a>
              </li>
            </ul>
          </div>
            ...
            <div className="grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out">
                <header>
                  ...
                  <div className="mb-3">
                    <ul className="flex flex-wrap text-xs font-medium -m-1">
                      <li className="m-1">
                        <a className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="./TutorialsList#0">Guides</a>
                      </li>
                      <li className="m-1">
                        <a className="inline-flex text-center text-gray-800 py-1 px-3 rounded-full bg-blue-100 hover:bg-blue-200 transition duration-150 ease-in-out" href="./TutorialsList#0">Intermediate</a>
                      </li>
                      <li className="m-1">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <div>
                    ...
                    <a className="font-medium hover:underline" href="./TutorialsList#0">Lisa Allison</a> & <a className="font-medium hover:underline" href="./TutorialsList#0">Justin Park</a>
                  </div>
                </footer>
              </article>
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="150">
                <header>
                  ...
                  <div className="mb-3">
                    <ul className="flex flex-wrap text-xs font-medium -m-1">
                      <li className="m-1">
                        <a className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="./TutorialsList#0">Tutorials</a>
                      </li>
                    </ul>
                  </div>
                  <h3 className="text-xl font-bold leading-snug tracking-tight mb-2">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <div>
                    <span className="text-gray-600">By </span>
                    <a className="font-medium hover:underline" href="./TutorialsList#0">Knut Mayer</a>
                  </div>
                </footer>
              </article>
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="300">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <div>
                    <span className="text-gray-600">By </span>
                    <a className="font-medium hover:underline" href="./TutorialsList#0">Lisa Allison</a>
                  </div>
                </footer>
              </article>
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out">
                <header>
                  ...
                  <div className="mb-3">
                    <ul className="flex flex-wrap text-xs font-medium -m-1">
                      <li className="m-1">
                        <a className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="./TutorialsList#0">Free ebooks</a>
                      </li>
                    </ul>
                  </div>
                  <h3 className="text-xl font-bold leading-snug tracking-tight mb-2">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <div>
                    <span className="text-gray-600">By </span>
                    <a className="font-medium hover:underline" href="./TutorialsList#0">Micheal Osman</a>
                  </div>
                </footer>
              </article>
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="150">
                <header>
                  ...
                  <div className="mb-3">
                    <ul className="flex flex-wrap text-xs font-medium -m-1">
                      <li className="m-1">
                        <a className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="./TutorialsList#0">Tips & Tricks</a>
                      </li>
                    </ul>
                  </div>
                  <h3 className="text-xl font-bold leading-snug tracking-tight mb-2">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <div>
                    <span className="text-gray-600">By </span>
                    <a className="font-medium hover:underline" href="./TutorialsList#0">Justin Park</a>
                  </div>
                </footer>
              </article>
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="300">
                <header>
                  ...
                  <div className="mb-3">
                    <ul className="flex flex-wrap text-xs font-medium -m-1">
                      ...
                      <li className="m-1">
                        <a className="inline-flex text-center text-gray-800 py-1 px-3 rounded-full bg-blue-100 hover:bg-blue-200 transition duration-150 ease-in-out" href="./TutorialsList#0">Beginner</a>
                      </li>
                      <li className="m-1">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <div>
                    <span className="text-gray-600">By </span>
                    <a className="font-medium hover:underline" href="./TutorialsList#0">Angela Fiorelli</a> & <a className="font-medium hover:underline" href="./TutorialsList#0">Lisa Allison</a>
                  </div>
                </footer>
              </article>
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <div>
                    <span className="text-gray-600">By </span>
                    <a className="font-medium hover:underline" href="./TutorialsList#0">Cory McCall</a>
                  </div>
                </footer>
              </article>
                ...
                <header>
                  ...
                  <div className="mb-3">
                    <ul className="flex flex-wrap text-xs font-medium -m-1">
                      ...
                      <li className="m-1">
                        <a className="inline-flex text-center text-gray-800 py-1 px-3 rounded-full bg-blue-100 hover:bg-blue-200 transition duration-150 ease-in-out" href="./TutorialsList#0">Advanced</a>
                      </li>
                      <li className="m-1">
