...
import TeamImage01 from '../../../../../../simple/simple-react/src/images/team-mosaic-01.jpg';
import TeamImage02 from '../../../../../../simple/simple-react/src/images/team-mosaic-02.jpg';
import TeamImage03 from '../../../../../../simple/simple-react/src/images/team-mosaic-03.jpg';
import TeamImage04 from '../../../../../../simple/simple-react/src/images/team-mosaic-04.jpg';
        ...
        <div className="py-12 md:py-20 border-t border-gray-200">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="-my-3">
              ...
              {/* 1st Item */}
              <a className="flex justify-between items-center p-4 rounded border border-gray-200 transition duration-300 ease-in-out bg-gray-100 shadow-md hover:bg-white hover:shadow-lg mb-3" href="./Career#0">
              ...
              {/* 4th Item */}
              <a className="flex justify-between items-center p-4 rounded border border-gray-200 transition duration-300 ease-in-out bg-gray-100 shadow-md hover:bg-white hover:shadow-lg" href="./Career#0">
