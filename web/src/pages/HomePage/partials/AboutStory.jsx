...
import AboutImage from '../../../../../../simple/simple-react/src/images/about-02.jpg';
import AboutLogo from '../../../../../../simple/simple-react/src/images/about-logo.png';
              ...
              <div className="flex  mb-8">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-gray-600 mt-2">
                    <cite className="text-gray-900 not-italic">Micheal Osman</cite> · <a className="text-blue-600" href="./AboutStory#0">New York Times</a>
                  </div>
                </div>
              </div>
            </div>
