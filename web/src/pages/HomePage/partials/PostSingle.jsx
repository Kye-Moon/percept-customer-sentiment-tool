...
import NewsAuthor from '../../../../../../simple/simple-react/src/images/news-author-04.jpg';
import NewsImage from '../../../../../../simple/simple-react/src/images/news-single.jpg';
                ...
                <aside className="relative hidden lg:block w-64 mr-20 shrink-0">
                  <div data-sticky data-margin-top="100" data-sticky-for="768" data-sticky-wrap>
                    ...
                    <ul className="font-medium -my-1">
                      <li className="py-1">
                        <a className="flex items-center hover:underline" href="./PostSingle#introduction">
                      ...
                      <li className="py-1">
                        <a className="flex items-center hover:underline" href="./PostSingle#general">
                          <svg className="w-4 h-4 fill-current text-gray-400 mr-3 shrink-0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.3 8.7c-.4-.4-.4-1 0-1.4l7-7c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-7 7c-.4.4-1 .4-1.4 0zM7.3 14.7c-.4-.4-.4-1 0-1.4l7-7c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-7 7c-.4.4-1 .4-1.4 0zM.3 9.7c-.4-.4-.4-1 0-1.4l7-7c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-7 7c-.4.4-1 .4-1.4 0z" />
                          </svg>
                      ...
                      <li className="py-1">
                        <a className="flex items-center hover:underline" href="./PostSingle#additional">
                          <svg className="w-4 h-4 fill-current text-gray-400 mr-3 shrink-0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.3 8.7c-.4-.4-.4-1 0-1.4l7-7c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-7 7c-.4.4-1 .4-1.4 0zM7.3 14.7c-.4-.4-.4-1 0-1.4l7-7c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-7 7c-.4.4-1 .4-1.4 0zM.3 9.7c-.4-.4-.4-1 0-1.4l7-7c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-7 7c-.4.4-1 .4-1.4 0z" />
                          </svg>
                      ...
                      <li className="py-1">
                        <a className="flex items-center hover:underline" href="./PostSingle#conclusion">
                          <svg className="w-4 h-4 fill-current text-gray-400 mr-3 shrink-0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.3 8.7c-.4-.4-.4-1 0-1.4l7-7c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-7 7c-.4.4-1 .4-1.4 0zM7.3 14.7c-.4-.4-.4-1 0-1.4l7-7c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-7 7c-.4.4-1 .4-1.4 0zM.3 9.7c-.4-.4-.4-1 0-1.4l7-7c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-7 7c-.4.4-1 .4-1.4 0z" />
                          </svg>
                ...
                <div>
                  ...
                  <div className="flex items-center mb-6">
                    <div className="flex shrink-0 mr-3">
                      <a className="relative" href="./PostSingle#0">
                    ...
                    <div>
                      ...
                      <a className="font-medium hover:underline" href="./PostSingle#0">Micheal Osman</a>
                  ...
                  <div className="text-lg text-gray-600">
                    <p id="introduction" className="mb-8" style={{ scrollMarginTop: '100px' }}>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum. Neque sodales ut etiam sit amet <a className="text-gray-900 underline" href="./PostSingle#0">how to manage anything</a> malesuada proin libero nunc consequat interdum varius. Quam pellentesque nec nam aliquam sem <strong className="font-medium text-gray-900">et tortor consequat</strong>. Pellentesque adipiscing commodo elit at imperdiet. Semper auctor neque vitae tempus quam pellentesque nec. Amet dictum sit amet justo donec enim diam. <strong className="font-medium text-gray-900">Varius sit amet mattis vulputate enim</strong> nulla aliquet porttitor. Odio pellentesque diam volutpat commodo sed. Elit sed vulputate mi sit amet mauris commodo quis imperdiet.
                    </p>
                    <p className="mb-8">
                    ...
                    <p className="mb-8">
                      <a className="inline-flex items-center text-base text-blue-600 font-medium hover:underline" href="./PostSingle#0">
                    ...
                    <p className="p-4 bg-gray-100 border border-gray-300 rounded mb-8">
                      <a className="text-gray-900 underline" href="./PostSingle#0">Simple</a> is a sed viverra ipsum nunc aliquet bibendum enim eu augue ut lectus arcu bibendum at. Non sodales neque sodales ut etiam sit. Venenatis urna cursus eget nunc scelerisque viverra mauris in aliquam. Learn more <a className="text-gray-900 underline" href="./PostSingle#0">here</a>.
                    </p>
                    ...
                    <ul className="list-disc list-inside mb-8">
                      <li className="mb-1">
                        <a className="text-gray-900 underline" href="./PostSingle#0">E-commerce for etter lorem ipsum generator</a>
                      </li>
                      <li className="mb-1">
                        <a className="text-gray-900 underline" href="./PostSingle#0">Booking for lorem ipsum post generator</a>
                      </li>
                      <li className="mb-1">
                        <a className="text-gray-900 underline" href="./PostSingle#0">Retail for generic dummy blog post generator</a>
                      </li>
                      <li className="mb-1">
                        <a className="text-gray-900 underline" href="./PostSingle#0">On-demand services: Lorem ipsum generator shortcode</a>
                      </li>
                    </ul>
                    ...
                    <div>
                      ...
                      <div className="mt-8">
                        Interested in more tips like this? Check out <a className="text-gray-900 underline" href="./PostSingle#0">Introducing the Testing Field Guide</a>.
                                    </div>
                      <div className="mt-6">
