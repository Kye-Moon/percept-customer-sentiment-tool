...
import DocsImage01 from '../../../../../../simple/simple-react/src/images/docs-image-01.png';
import DocsImage02 from '../../../../../../simple/simple-react/src/images/docs-image-02.png';
    ...
    <div className="md:grow">
      ...
      <div className="text-lg text-gray-600">
        ...
        <p className="flex items-center text-base px-3 py-4 text-gray-800 bg-blue-100 border border-blue-200 rounded mb-8">
          ...
          <span>Check out the <a className="text-blue-600 hover:underline" href="./DocumentationContent#0">Terms and license page</a> to know more about our license.</span>
        </p>
        ...
        <p className="mb-8">
          Orci ac auctor augue mauris augue neque gravida in sapien faucibus et molestie ac feugiat sed lectus vestibulum mattis senectus et <a className="text-gray-900 underline" href="./DocumentationContent#0">netus et malesuada fames</a> ut faucibus pulvinar elementum integer pellentesque habitant morbi.
        </p>
        <figure className="mb-8">
        ...
        <p className="flex items-center text-base px-3 py-4 text-gray-800 bg-blue-100 border border-blue-200 rounded mb-8">
          ...
          <span>Learn more about <a className="text-blue-600 hover:underline" href="./DocumentationContent#0">Customising settings</a>.</span>
        </p>
      ...
      <div className="mt-8">
        ...
        <a className="flex justify-between items-center p-4 rounded border border-gray-200 transition duration-300 ease-in-out bg-white shadow-md hover:shadow-lg mb-4" href="./DocumentationContent#0">
          <div>
      ...
      <div className="pt-6">
        <div className="flex flex-col text-center sm:text-left sm:flex-row sm:justify-between sm:items-center">
          ...
          <ul className="inline-flex justify-center -m-2">
            <li className="p-2">
              <a href="./DocumentationContent#0" title="No, at all">
            ...
            <li className="p-2">
              <a href="./DocumentationContent#0" title="Not really">
                <svg className="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="p-2">
              <a href="./DocumentationContent#0" title="It was useful">
                <svg className="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <circle fill="#FFCC4D" cx="12" cy="12" r="12" />
            ...
            <li className="p-2">
              <a href="./DocumentationContent#0" title="Excellent">
                <svg className="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0s12 5.373 12 12" fill="#FFCC4D" />
