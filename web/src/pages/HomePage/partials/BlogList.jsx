                  ...
                  <footer className="text-sm">
                    <div className="flex items-center">
                      <div className="flex shrink-0 mr-3">
                        <a className="relative" href="./BlogList#0">
                      ...
                      <div>
                        ...
                        <a className="font-medium hover:underline" href="./BlogList#0">Micheal Osman</a>
                ...
                <div>
                  ...
                  <footer className="text-sm">
                    <div className="flex items-center">
                      ...
                      <div>
                        <span className="text-gray-600">By </span>
                        <a className="font-medium hover:underline" href="./BlogList#0">Lisa Allison</a>
                ...
                <div>
                  ...
                  <footer className="text-sm">
                    <div className="flex items-center">
                      ...
                      <div>
                        <span className="text-gray-600">By </span>
                        <a className="font-medium hover:underline" href="./BlogList#0">Knut Mayer</a>
                        <span className="text-gray-600"> · July 19, 2020</span>
                      </div>
                    </div>
                  </footer>
                ...
                <div>
                  ...
                  <footer className="text-sm">
                    <div className="flex items-center">
                      ...
                      <div>
                        <span className="text-gray-600">By </span>
                        <a className="font-medium hover:underline" href="./BlogList#0">Justin Park</a>
                ...
                <div>
                  ...
                  <footer className="text-sm">
                    <div className="flex items-center">
                      ...
                      <div>
                        <span className="text-gray-600">By </span>
                        <a className="font-medium hover:underline" href="./BlogList#0">Cory McCall</a>
                ...
                <ul className="-my-2">
                  <li className="flex py-2 border-b border-gray-200">
                    ...
                    <div className="font-medium mb-1">
                      <a className="hover:underline" href="./BlogList#0">
                        News & Updates
                                    </a>
                    </div>
                  </li>
