    ...
    <>
      ...
      <div className={"flex flex-col "}>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          {/* Welcome banner */}
          <DashboardStatisticsCell/>
          <div className={"divider"}></div>
          {/* Cards */}
          <div className={"flex justify-between py-2 mb-12 "}>
            <h1 className={"text-4xl font-bold"}>Campaigns</h1>
            <Link className={"btn btn-primary bg"} to={routes.createCampaign()}>Create New Campaign</Link>
          </div>
          <CampaignsCell/>
          <div className={'mt-40'}>
            <footer className="footer p-12 border-t text-base-content">
              <div>
